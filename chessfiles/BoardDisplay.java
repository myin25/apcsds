...
public class BoardDisplay implements ActionListener
{
    ...
    private void createAndShowGUI()
    {
        ...
        frame.getContentPane().setLayout(new GridLayout(board.getNumRows(),
                    board.getNumCols()));
     ...
     * @param event                 indicates that the board was interacted
     *                              with
     */
    public void actionPerformed(ActionEvent event)
    {
        ...
        if (selectedPiece == null)
        {
            ...
            if (selectedPiece != null)
            {
                ...
                for (Location dest : selectedPiece.destinations())
                {
                    setColor(dest, Color.YELLOW);
                }
            }
        }
     ...
     * @param loc               the location where the border is changing color
     * @param color             the color the border is changing to
     */
